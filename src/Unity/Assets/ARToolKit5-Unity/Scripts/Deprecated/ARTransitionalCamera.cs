...
//	// In camera parent frame.
//    public  Vector3     vrTargetPosition            = Vector3.zero;
//	public  Quaternion  vrTargetRotation            = Quaternion.identity;
//
//    public  GameObject  targetObject                = null;
//    public  float       transitionAmount            = 0.0f;
//	// Gentle walking speed, 1.389 m/s = 5 km/hr = 3.107 miles/hr.
...
//
//    private IEnumerator DoTransition(bool flyIn) {
...
//                transitioning = false;
//            }
//			ARController.Instance.SetVideoAlpha(1.0f - transitionAmount);
//            yield return null;
//        }
//		transition = null;
//    }
...
//			transition = null;
//		}
//        transition = StartCoroutine(DoTransition(true));
//    }
//
...
//			transition = null;
//		}
//		transition = StartCoroutine(DoTransition(false));
//    }
//
//    private void Start() {
...
//        }
//
//		if (!automaticTransition || !arVisible) {
//			return;
//		}
//		if (arPosition.magnitude < automaticTransitionDistance && transitionAmount != 1) {
//			transitionIn();
//        }
//    }
//
