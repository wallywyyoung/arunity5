...
//		return string.Format(SINGLE_BUFFER_CONFIG, PatternWidthMM * ARTrackedMarker.ARTOOLKIT_TO_UNITY, PatternContents);
//	}
...
//	public        float PatternWidthMM;
//	public string GetConfigString() {
//		return string.Format(SINGLE_BARCODE_CONFIG, BarcodeID, PatternWidth * ARTrackedMarker.ARTOOLKIT_TO_UNITY);
//	}
////		UseContPoseEstimation = ContinuousPoseEstimation;
//}
//
